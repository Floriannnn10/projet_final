                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <label for="modele_app">Modèle</label>
                                <input type="text" class="form-control" id="modele_app" name="modele_app">
                            </div>
                            <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="giga">giga</label>
                                <input type="text" class="form-control" id="giga" name="giga">
                            </div>
                            <div class="form-group">
